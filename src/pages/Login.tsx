  ...
  return (
    <Stack justifyContent='center' alignItems='center' sx={{ height: '100vh' }}>
      <Stack justifyContent='center' alignItems='center'>
        <WhatsAppIcon color='success' sx={{ fontSize: 120, mb: 3 }} />
        <Typography component='h1' variant='h5' fontWeight={500} sx={{ mb: 3 }}>
          Welcome to WhatsApp
        </Typography>
        <Stack component='form' alignItems='center' onSubmit={handleSubmit}>
          {showOtpField ? (
            <>
              <Typography sx={{ mb: 2 }}>Enter SMS code</Typography>
              <Input
                type='password'
                name='token'
                style={{ mb: 6 }}
            ...
            <>
              <Typography sx={{ mb: 2 }}>Enter phone number</Typography>
              <MuiTelInput
                sx={{ mb: 6 }}
                defaultCountry='MY'
                value={phone}
